...
$g="select * from generos where codGenero='$_GET[codG]'";

$rg = mysqli_query($lig, $g) or die("3");

$lg =mysqli_fetch_assoc($rg);
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #5c3a3a;">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
	...
	<form class="main_form" action="atualizaG.php" method="post" enctype="multipart/form-data">


	<div class=" col-md-12">
	<label><font size="5"> Codigo: </font></label><br>
	<input  class="form-control" type="text" name="cod" value="<?php echo $lg[codGenero]; ?>" readonly>
	</div>
	
	<div class=" col-md-12">
	<label><font size="5"> Nome: </font></label><br>
	<input  class="form-control" type="text" name="nome" value="<?php echo $lg[nome_genero]; ?>">
	</div>
